...
public class StoreWelcomeAdapter extends RecyclerView.Adapter<StoreWelcomeAdapter.ViewHolder> {

    private Context context;
    private List<Store> storeList;


    public StoreWelcomeAdapter(Context context, List<Store> storeList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from( context ).inflate( R.layout.item_store_welcome, viewGroup, false );
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.storeContainer1.setOnClickListener( new View.OnClickListener() {
            @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        RelativeLayout storeContainer1;



        public ViewHolder(@NonNull View itemView) {
            super( itemView );
        ivItemStore = itemView.findViewById( R.id.iv_logo_item_store1 );
        tvItemStoreName = itemView.findViewById( R.id.tv_name_item_store1 );
        tvItemStoreDescription = itemView.findViewById( R.id.tv_description_item_store1 );
        storeContainer1 = itemView.findViewById( R.id.storeContainer1 ) ;
        }
